...
png(file = "plot4.png",width = 480, height = 480) #save the plot to a png file
par(mfrow=c(2,2)) #change the layout to have two lines and two columns

#first plot
plot(sub_data$my_Time,sub_data$Global_active_power,type="l",
     ylab="Global Active Power (kilowatts)",
     xlab="")

#second plot
plot(sub_data$my_Time,sub_data$Voltage,type="l",
     ylab="Voltage",
     xlab="datetime")
#third plot
...
#fourth plot
plot(sub_data$my_Time,sub_data$Global_reactive_power,type="l",
